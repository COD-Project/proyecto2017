...
       To know the IP of your server, just do from any terminal "ping -a yourwebsite.com"
    */
    ...
    private function getEnv($s)
    {
        ...
        } elseif (function_exists('apache_getenv') and apache_getenv($s, true)) {
    ...
    */
    ...
    const CT_RULES = [
      'applet', 'base', 'bgsound', 'blink', 'embed', 'expression',
    ...
    public function __construct()
    {
        ...
        if (self::FCONF['PROTECTION_URL']) {
            $ct_rules = [
              'absolute_path', 'ad_click', 'alert(', 'alert%20', ' and ', 'basepath', 'bash_history', '.bash_history',
